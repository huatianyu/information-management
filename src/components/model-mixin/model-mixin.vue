...
import { getSize, getCenter } from "@/components/webgl-tools/util";
import { OrbitControls } from "@/components/webgl-tools/controls/OrbitControls";
...
// 				folderGlobal.add( propsGlobal, 'Plane', - 0.4, 3 );
        ...
        //   light.add(new PlaneHelper(clipPlanes1[0], 2, 0xff0000));
        //   light.add(new PlaneHelper(clipPlanes1[1], 2, 0x00ff00));
        //   light.add(new PlaneHelper(clipPlanes[2], 2, 0x0000ff));
        //   light.visible = true;
        //   if (item.position) {
        //     light.position.copy(item.position);
        //   }
          ...
          //  plane = new Plane(),
          //      				plane =  Plane( Vector3( 0, - 1, 0 ), 0.8 );

          //         			camera = PerspectiveCamera( 36, window.innerWidth / window.innerHeight, 0.25, 16 );

          // //  camera =  PerspectiveCamera( 36, 0.5, 0.25, 16 );

          //             // const skyColor = item.skyColor || 0xffffff;
          //             // const groundColor = item.groundColor || 0xffffff;
          //             // const intensity = item.intensity || 1;

          //             light =  WebGLClipping( plane, false, camera );
  ...
  var params = {
   ...
   var clipPlanes = [
        ...
        //   }
				...
				// object = new Mesh( object, material );
