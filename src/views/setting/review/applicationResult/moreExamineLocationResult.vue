...
export default class MoreExamineLocationResult extends AbpBase {
  fav = true;
  menu = false;
  message = false;
  hints = true;
  ...
  get tab() {
    return this.$store.state.targetResource.moreExamineLocationResultTab;
  }
  set tab(value) {
    this.$store.state.targetResource.moreExamineLocationResultTab = value;
  }
  get routerName() {
  ...
  async getpage() {
    ...
    await this.$store.dispatch({
      type: 'more/examineLocationResultAsync',
