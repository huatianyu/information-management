<template>
  <v-flex>
    <Affix v-if="searchBarFixed" class="target-affixPosition" :offset-top="0">
        ...
        <div class="page-body">
          <div id="printTargetingApplication">
            ...
            >
              <Row :gutter="10">
                <Col span="24">
                  <patient-search-item v-model="remarks" type="textarea" title="备注" signature="李大庆"></patient-search-item>
                </Col>
              </Row>
                ...
                <Collapse v-model="value2" class="hidden-border">
                  <Panel hide-arrow name="1">
                    ...
                    <p slot="content">
                      ...
                      <Row :gutter="10">
                        <Col span="24">
                          <FormItem v-if="status" :labelWidth="110" :label="L('体位')+':'">
                      ...
                      <Row :gutter="10">
                        <Col span="10">
                          ...
                          >
                            ...
                            >
                              <Option
                                v-for="item in ScanningLocation"
                                :value="item.id"
                              >{{item.value}}</Option>
                            </Select>
                          </FormItem>
