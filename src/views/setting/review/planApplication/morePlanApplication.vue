...
export default class MorePlanApplication extends AbpBase {
  fav = true;
  menu = false;
  message = false;
  hints = true;
  ...
  get tab() {
    return this.$store.state.targetResource.morePlanApplicationTab;
  }
  set tab(value) {
    this.$store.state.targetResource.morePlanApplicationTab = value;
  }
  get routerName() {
